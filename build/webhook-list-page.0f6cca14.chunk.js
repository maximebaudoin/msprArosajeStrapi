"use strict";(self.webpackChunkmspr_arosaje_strapi=self.webpackChunkmspr_arosaje_strapi||[]).push([[4121],{11199:(U,p,t)=>{t.r(p),t.d(p,{default:()=>ue});var e=t(67294),a=t(81849),b=t(87751),h=t(16550),L=t(86896),O=t(14087),C=t(17034),D=t(185),c=t(53979),f=t(36989),i=t(75515),M=t(29728),x=t(49066),H=t(41580),_=t(38939),ee=t(49386),te=t(8060),G=t(79031),E=t(37909),j=t(41451),ne=t(63237),le=t(15234),S=t(11047),y=t(45697),N=t(71997);const $=N.ZP.div`
...
`,c=(0,b.ZP)(h.x)`
  ...
  width: 100%;
  border: none;
`,f=({children:i,icon:M,...x})=>e.createElement("div",null,e.createElement(L.i,null),e.createElement(c,{as:"button",background:"primary100",padding:5,...x},e.createElement(O.k,null,e.createElement(D,{"aria-hidden":!0,background:"primary200"},M),e.createElement(h.x,{paddingLeft:3},e.createElement(C.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600"},i)))));f.propTypes={children:a.string.isRequired,icon:a.node.isRequired}}}]);
